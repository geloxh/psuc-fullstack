...
<div class="paper-container">
    ...
    <div class="paper-content">
        ...
        <div  class="section">
            ...
            <div class="model-grid">
                <div class="model-card">
                    ...
                    <p>SUCs often form consortia to harmonize academic programs, share faculty, and pursue joint research. For example, the Mindanao Association of State Tertiary Schools (MASIS) facilitates collaborative activities among Mindano-based institutions.</p>
                </div>
                <div class="model-card">
                ...
                <div class="model-card">
                    <h4>5. Colaboration with Local Dovernaments and NGOs</h4>
                    <p>SUCs often partner with LGUs and NGOs for extension programs, disaster risk maagement, agricultural innovation, and health initiatives - enhancing their community engagement mandates.</p>
                </div>
            </div>
        </div>
        <div class="section">
            ...
            <p><strongs>Resource Inequality:</strongs> Some SUCs are better positioned to collaborate than others, creating disparities.</p>
        ...
        <div class="section">
            <h2>Opportunities and Prospect</h2>
